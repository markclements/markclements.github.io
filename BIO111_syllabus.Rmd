...
1. BIO 111-2: M and W (2-3:15 E369); W (11-1:30 E356)  
2. BIO 111-T9: T and R (9:30-10:45 E260); R (11-1:30 E356)  
...
The course is divided into several modules. Modules have interactive discusions of background readings, slide shows and additional media (articles and videos) and worksheets to introduce ideas. You will complete these before class and I will review them and identify difficult or confuisng ideas and create interactive, in-class activities to help you better understand and makes sense of the material. Finally, there are lab activities that introduce scientific principles (experimental design, data collection, analysis, and evidence-based argumentation) and focus on the tools and techniques used in Biology.  

## Workload

The requires a minimum of 5 hours of coursework per module and you will complete 1 module per week. Pre-class coursework is completed online, before class and lab activities will be completed during scheduled meeting times. Attendance is required for all face-to-face meetings.  
...
We will meet 3 times per week; once for lab and twice for "lecture" and these meetings are not optional. If you can not make it to a face-to-face, on-campus meeting you will not be allowed to make up the work for that day. However, I will drop the lowest score for lab and pre-class activity and allow 2 "lecture" absences.    
...
Traditonal, Face-to-face: This form of education is characterized by an emphasis on in-person ineractions between students and faculty.
...
If yes, dates, times, places are to be specified: BIO111-T9: Weekly on-campus on Tuesday (9:30-10:45, 11-1:30) and Thursday (9:30-10:45). BIO111-2: Weekly on campus on Monday (2-3:15) and Wednesday (11-1:30, 2-3:15).
