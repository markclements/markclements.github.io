...
---
###Week 1
####Tue-20-Jun: Introduction to course  

The following must be completed prior to attending class 22 Jun 2017:  
**Syllabus Contract**

1. Please read the [**sylabus (CLICK HERE)**](google.com). You can access the document by clicking the link or by using the link located in the left-handed navigation bar in BlackBoard
2. [**CLICK HERE**](google.com) to access the syllabus acknowledgement form. 
